...
INCLUDE_PATHS='-I$(LIBS_PATH)/VulkanMemoryAllocator-3.1.0/include' '-I$(LIBS_PATH)/glfw-3.4.bin.WIN64/include' '-I$(VULKAN_SDK)\Include' '-I$(LIBS_PATH)/tinyobjloader' '-I$(LIBS_PATH)'
